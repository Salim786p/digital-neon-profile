...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'neon-primary': 'var(--shadow-primary)',
				'neon-secondary': 'var(--shadow-secondary)',
				'neon-accent': 'var(--shadow-accent)',
				'neon-highlight': 'var(--shadow-highlight)',
				'neon-intense': 'var(--shadow-intense)',
			},
			borderRadius: {
				lg: 'var(--radius)',
